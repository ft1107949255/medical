    ...
    window.addEventListener("message", function(res) {
      if (res.data && !res.data.hasOwnProperty("type")) {
        ...
        if (data.doSave) {
          ...
          //   .post(
          //     that.ip +
          //       "/xhhms/rest/interRemoteReportController/v1/doCloudSave",
          //     params,
          //     {
          //       headers: {
          ...
          //     }
          //   )
            that.$api.EditCloudDocloudSave(params).then(
              res => {
                var data = res;
  ...
  methods: {
    ...
    shuyuOnClick(event, treeId, treeNode) {
      if (!treeNode.isParent) {
        ...
        //     }
        //   )
        this.$api.getConsulationEditKnowledgeById(params).then(
          res => {
            var data = res;
            if (!!data && data.status == "1") {
    ...
    send: function() {
      ...
      // this.$http
      //   .post(
      //     this.ip + "/xhhms/rest/interRemoteReportController/v1/doCloudSend",
      //     params,
      //     {
      //       headers: { "X-AUTH-TOKEN": localStorage.getItem("token") }
      //     }
      //   )
      this.$api.EditClouddoCloudSend(params).then(
        res => {
          var data = res;
          if (!!data && data.status == "1") {
            this.$message({
    ...
    noPass: function() {
      ...
      // this.$http
      //   .post(
      //     this.ip + "/xhhms/rest/interRemoteReportController/v1/doCloudReject",
      //     params,
      //     {
      //       headers: { "X-AUTH-TOKEN": localStorage.getItem("token") }
      //     }
      //   )
      this.$api.EditClouddoCloudReject(params).then(
        res => {
          var data = res;
          if (!!data && data.status == "1") {
            this.$message({
    ...
    cancelSend: function() {
      ...
      //   .post(
      //     this.ip +
      //       "/xhhms/rest/interRemoteReportController/v1/doCloudCancelSend",
      //     params,
      //     {
      //       headers: { "X-AUTH-TOKEN": localStorage.getItem("token") }
      //     }
      //   )
      this.$api.EditClouddoCloudCancelSend(params).then(
        res => {
          var data = res;
          if (!!data && data.status == "1") {
            this.$message({
    ...
    chargeReport: function() {
      ...
      //   .post(
      //     this.ip +
      //       "/xhhms/rest/interRemoteReportController/v1/diagnosticCloudrecord",
      //     params,
      //     {
      //       headers: { "X-AUTH-TOKEN": localStorage.getItem("token") }
      //     }
      //   )
        this.$api.EditClouddiagnosticCloudrecord(params).then(
          res => {
            var data = res;
            if (!!data && data.status == "1") {
    ...
    OkDialogReportBeizhu: function() {
      if (this.textareaReportBeizhu !== "") {
        ...
        //   .post(
        //     this.ip +
        //       "/xhhms/rest/interRemoteReportController/v1/doCloudRemark",
        //     params,
        //     {
        //       headers: { "X-AUTH-TOKEN": localStorage.getItem("token") }
        //     }
        //   )
          this.$api.EditClouddoCloudRemark(params).then(
            res => {
    ...
    seeMedia: function() {
      window.open("/#/patientimages?patientId=" + this.id +"&code=1", "_blank");
    },
    opensave: function() {
    ...
    getPatientInfo: function() {
      ...
      //   .post(
      //     this.ip +
      //       "/xhhms/rest/interRemoteReportController/v1/getCloudReportByid",
      //     params,
      //     {
      //       headers: {
      //         "X-AUTH-TOKEN": this.token
      ...
      //     }
      //   )
        this.$api.EditCloudgetCloudReportByid(params).then(
          res => {
            var data = res;
    ...
    FirstCharge: function() {
      ...
      //   .post(
      //     this.ip +
      //       "/xhhms/rest/interRemoteReportController/v1/updateCloudStatus",
      //     params,
      //     {
      //       headers: {
      //         "X-AUTH-TOKEN": this.token
      ...
      //     }
      //   )
        this.$api.EditCloudupdateCloudStatus(params).then(
          res => {
            var data = res;
            //console.log(data);
            if (!!data && data.status == "1") {
