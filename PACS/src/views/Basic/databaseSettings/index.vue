...
export default {
  ...
  data() {
    return {
      ...
      // tableApi
      tableApi: {
        list: 'databaseSettingGetlist',
        add: 'databaseSettingAdd', 
        del: 'databaseSettingDel',
        update: 'databaseSettingUpdate', 
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    isSearch() {
      this.mixinGetData({dbName: this.inputstr})
    },
    handleIndexChange() {},
    handleSizeChange() {}
  },
