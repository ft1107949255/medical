...
<div id="app">
  <div class="collection">
    <a href="#!" class="collection-item"
       v-for="(gameName,key) in gameNames"
       :key = "key"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _getHospitalList() {
        var params = {};
        this.$api.getLeftHospitalListApi(params).then((res) => {
          var data = res.data;
          if (data.status == 1) {
              data.data.map(item => {
      ...
      _getDeviceTypeList() {
        var params = {};
        this.$api.getLeftDeviceTypeListApi(params).then((res) => {
          var data = res.data;
          if (data.status == 1) {
      ...
      _getCheckItemList() {
        var params = {};
        this.$api.getLeftCheckItemListApi(params).then((res) => {
          var data = res.data;
          if (data.status == 1) {
