...
export default {
  ...
  data() {
    return {
      ...
      // tableApi
      tableApi: {
        list: 'checkitemSettingGetAll',
        add: 'checkitemSettingAdd',
        update: 'checkitemSettingUpdate',
        del: 'checkitemSettingDel'
      }
    };
  },
  created() {
