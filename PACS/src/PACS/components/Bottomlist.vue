    ...
    <div class="bottom_div">
      ...
      <div class="from">
        <el-row type="flex" justify="space-around">
         ...
         <el-col :span="3">
           <span>病人ID</span>
           <el-input v-model="from.patientNo" clearable class="el-input"  size="mini" @change="change3"></el-input>
         </el-col>
          <el-col :span="3">
           <span>姓名</span>
...
<script>
import tables from "./../components/HomeBottomTables.vue";
 ...
 created() {
  ...
  methods: {
   ...
   _getDeviceTypeList() {
      ...
      //   this.from.deviceType = data[0];
      //   this.from.deviceType = data[1];
      // },
      change7(value) {
